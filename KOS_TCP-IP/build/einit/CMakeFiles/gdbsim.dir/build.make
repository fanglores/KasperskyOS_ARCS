...
einit/CMakeFiles/gdbsim: einit/.gdbinit
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/workspace/KOS_TCP-IP/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Running QEMU with KasperskyOS image..."
	cd /workspace/KOS_TCP-IP/build/einit && /opt/KasperskyOS-Community-Edition-1.0.1.4/toolchain/bin/qemu-system-arm -m 2048 -machine vexpress-a15 -nographic -monitor none -serial stdio -serial tcp::12345,server,nowait -s -S -kernel /workspace/KOS_TCP-IP/build/einit/kos-qemu-image
...
einit/kos-qemu-image: einit/EinitQemu-kss/ksm.module
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/workspace/KOS_TCP-IP/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Generating KasperskyOS image: /workspace/KOS_TCP-IP/build/einit/kos-qemu-image"
...
einit/EinitQemu-kss/ksm.module: einit/EinitQemu
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/workspace/KOS_TCP-IP/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Generating EinitQemu-kss/ksm.module, EinitQemu-kss/security_arm.psl.audit.c"
...
einit/CMakeFiles/gdbsim.dir/clean:
	cd /workspace/KOS_TCP-IP/build/einit && $(CMAKE_COMMAND) -P CMakeFiles/gdbsim.dir/cmake_clean.cmake
.PHONY : einit/CMakeFiles/gdbsim.dir/clean

einit/CMakeFiles/gdbsim.dir/depend:
	cd /workspace/KOS_TCP-IP/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /workspace/KOS_TCP-IP /workspace/KOS_TCP-IP/einit /workspace/KOS_TCP-IP/build /workspace/KOS_TCP-IP/build/einit /workspace/KOS_TCP-IP/build/einit/CMakeFiles/gdbsim.dir/DependInfo.cmake --color=$(COLOR)
