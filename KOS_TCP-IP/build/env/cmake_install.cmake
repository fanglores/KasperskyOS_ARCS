# Install script for directory: /workspace/KOS_TCP-IP/env
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xnk_headersx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/include/env" TYPE FILE FILES
    "/workspace/KOS_TCP-IP/build/_headers_/env/../env/Env.edl"
    "/workspace/KOS_TCP-IP/build/_headers_/env/../env/Env.edl.h"
    )
endif()
